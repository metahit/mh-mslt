...
5) Code to run the life table only.

Table 1 is an overview of inputs, ouputs and code to generate them. 
...
kable(inputs_outputs, booktabs = T, caption = " Table 1: PMSLT inputs", longtable = TRUE) %>%
...
This sections can be run independently from the rest. 
