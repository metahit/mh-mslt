...
### Generate graphs over simulation period
Inputs requiered generated above. However, here, I demonstrate the use of the function run_MSLT and generate some graphs.
...
plot_1
ggsave(plot_1, file=paste0("./output/graphs/diseases/incidence.png"), width = 14, height = 10, units = "cm")
...
plot_2 <- data %>%
  ...
  theme(legend.position = "bottom",
        ...
        axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
plot_2
ggsave(plot_2, file=paste0("./output/graphs/diseases/deaths.png"), width = 14, height = 10, units = "cm")
...
plot_3 <- data_t %>%
  ...
  geom_hline(yintercept=0, linetype='dashed', color = 'black')
plot_3
ggsave(plot_3, file=paste0("./output/lifeyears/lifeyears.png"), width = 14, height = 10, units = "cm")
