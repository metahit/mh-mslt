...
Use **GetGBD** to map local_government_areas names to GBD input data names.
...
disease_names_execute=read_xlsx("~/mh-execute/inputs/dose_response/disease_outcomes_lookup_2.xlsx")
