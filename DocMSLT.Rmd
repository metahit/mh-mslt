...
kable(outputs[["LifeYears"]], booktabs = T, caption = "Table 3: Life Years", longtable = TRUE) %>%
column_spec(1:1, width = "15em") %>%
  row_spec(0, bold = T) %>%
  kable_styling()

kable(outputs[["LifeExpectancy"]], booktabs = T, caption = "Table 5: Life Expectancy", longtable = TRUE) %>%
column_spec(1:1, width = "15em") %>%
  row_spec(0, bold = T) %>%
  kable_styling()

kable(outputs[["Cause"]], booktabs = T, caption = "Table 6: Diseases", longtable = TRUE) %>%
column_spec(1:1, width = "15em") %>%
  row_spec(0, bold = T) %>%
  kable_styling()
```
