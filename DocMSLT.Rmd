...
disease_names_execute=paste0(relative_path_execute, "/inputs/dose_response/disease_outcomes_lookup_new.csv")) %>% ### diseases not to include
...
### Run scenarios diseases processes (CHECK ISSUE HERE: 10-11-22)
